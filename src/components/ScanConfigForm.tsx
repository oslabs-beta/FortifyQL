  ...
  <div className='container'>
    <form className='input_form'>
      <h1>FortifyQL</h1>
        ...
        <input id='textbox' type='text' placeholder='Enter GraphQL API URI here' onChange={handleEndpoint}></input>
        ...
        <div className='tests'> 
         ...
         <label className='switch' >
          <input type='checkbox' value='injection-scan' 
        ...
        <label className='text'><b>Denial of Service (DoS) Scan:&nbsp;</b> Resource exhaustion via nested queries.</label>
         <label className='switch'>
          <input type='checkbox' value='DoS-scan' 
            onChange={handleSelectedTests}/>
           <span className='slider'/>
         </label>
        </div>
        ...
        <div className='tests'> 
        <label className='text'><b>Authorization Configuration Scan:&nbsp;</b> Use administration email and brute force login credentials.</label>
         <label className='switch'>
          <input type='checkbox' value='authorization-scan'
            onChange={handleSelectedTests}/>
           <span className='slider'/>
         </label>
        </div>
        ...
        <label className='text'><b>Batching Scan:&nbsp;</b> Common for authentication vulnerabilities and bypassing rate limiting. A mutation to password reset, bypassing 2FA/OTP by batch sending tokens.</label>
         <label className='switch'>
          <input type='checkbox' value='batching-scan'
            onChange={handleSelectedTests}/>
           <span className='slider'/>
         </label>
        </div>
        ...
        <label className='text'><b>Introspection Scan:&nbsp;</b> A query that performs an operation to pull the information from the backend of the application.</label>
         <label className='switch'>
          <input type='checkbox' value='introspection-scan'
            onChange={handleSelectedTests}/>
           <span className='slider'/>
         </label>
        </div>
     ...
     <button id='submit_button' onSubmit={handleSubmit}>Submit</button>
    </form>
  </div>
  )
};
